...
#+end_export
  ...
  *Modalità di esame telematiche*:  a causa dell'impossibilita di fare
  ...
  installare il browser web sicuro  [[https://support.exam.net/#/seb][SEB]]. Per la teleconferenza dovrete
  installare  e usare  Google  Meet su  *un  secondo dispositivo*,  ad
  esempio uno smartphone o un secondo computer.
  ...
  2. Installare Google Meet sul secondi dispositivo.
  3. Poco  prima dell'esame verranno inviati  sull'email istituzionale
     *dei soli prenotati all'appello* gli  inviti per la conferenza in
     Google Meet.
  4. Contestualmente  (sull'email  istituzionale)  verrà
  ...
  5. La  piattaforma [[https://exam.net][Exam.net]]  vi chiude  fuori dall'esame  se passate
     a qualche  altra applicazione. E  solo il docente  può ammettervi
     nuovamente all'esame.
  6. L'esame sarà  più o  meno  come al  solito (vedi  sotto), ma  la
