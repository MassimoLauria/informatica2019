...
esercizio_file = 'lab11ordinata'
esercizio_funzione = 'ordinata'

casi_di_test = [
    Testcase(name="disordinato1",
             input=([-4, -7, 2, -5, -6, -9, 6, 9, 7, 5, 3], ),
             result=False),
    Testcase(name="disordinato2", input=([1, -7, 8, 6, 2], ), result=False),
    Testcase(name="vuota", input=([], ), result=True),
    Testcase(name="unitaria", input=([3], ), result=True),
    Testcase(name="reverse", input=([3, 2, -5, -6, -7], ), result=False),
    Testcase(name="ripetizione", input=([1, 1, 1, 1, 1, 1, 1], ), result=True),
    Testcase(name="quasi ordinata",
             input=([-4, -3, -1, -2, 0, 1, 2, 3, 4, 5], ),
             result=False)
]
