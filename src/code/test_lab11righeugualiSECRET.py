...
esercizio_file = 'lab11righeuguali'
esercizio_funzione = 'righe_uguali'

una_riga_sola = [[-10, -2, 8, -9, -1, -9]]

due_uguali = [[4, -5, -4, -9, 4], [4, -5, -4, -9, 4]]

due_diverse = [[4, -5, -4, -9, 4], [10, 6, 5, 3, -9]]

tre_uguali = [[5, 3, 8, -4, 0], [5, 3, 8, -4, 0], [5, 3, 8, -4, 0]]

due_e_tre_separate = due_uguali + tre_uguali

tre_e_tre_miste = [[10, -7], [-8, -8], [-8, -8], [10, -7], [-8, -8], [10, -7]]

tre_uguali_interrotte = [[-5, 1, 1, 3, 8, -8], [-5, 1, 1, 3, 8, -8],
                         [0, 0, 0, 0, 0, 0], [-5, 1, 1, 3, 8, -8]]

casi_di_test = [
    Testcase(name="una riga sola", input=(una_riga_sola, ), result=[]),
    Testcase(name="due uguali", input=(due_uguali, ), result=[[0, 1]]),
    Testcase(name="due diverse", input=(due_diverse, ), result=[]),
    Testcase(name="tre uguali",
             input=(tre_uguali, ),
             result=[[0, 1], [0, 2], [1, 2]]),
    Testcase(name="due e tre, separate",
             input=(due_e_tre_separate, ),
             result=[[0, 1], [2, 3], [2, 4], [3, 4]]),
    Testcase(name="tre e tre, miste",
             input=(tre_e_tre_miste, ),
             result=[[0, 3], [0, 5], [1, 2], [1, 4], [2, 4], [3, 5]]),
    Testcase(name="tre uguali, interrotte",
             input=(tre_uguali_interrotte, ),
             result=[[0, 1], [0, 3], [1, 3]]),
]
