...
esercizio_file = 'lab09trasposta'
esercizio_funzione = 'trasposta'
...
casi_di_test = [
    ...
    Testcase(name="prima riga corta", input=([[3,4,5], [1,2,3,4]],), error=TypeError,
             explanation="non è una matrice rettangolare"),

    Testcase(name="prima riga lunga", input=([[3,4,5,6,7], [1,2,3,4]],), error=TypeError,
             explanation="non è una matrice rettangolare"),

    Testcase(name="terza riga lunga", input=([[3,4,5,6,7], [3,4,5,6,7], [3,4,5,6,7,8], [3,4,5,6,7]],), error=TypeError,
             explanation="non è una matrice rettangolare"),

    Testcase(name="terza riga corta", input=([[3,4,5,6,7], [3,4,5,6,7], [3,4,5,6], [3,4,5,6,7]],), error=TypeError,
             explanation="non è una matrice rettangolare"),

    Testcase(name="matrice 4 x 1", input=([[3], [3], [3], [3]],), result=[[3, 3, 3, 3]]),

    Testcase(name="matrice 4 x 2", input=([[3, 4], [3, 1], [3, 2], [2, 3]],), result=[[3, 3, 3, 2], [4, 1, 2, 3]]),

    Testcase(name="matrice 1 x 1", input=([[3]],), result=[[3]]),

    Testcase(name="matrice 1 x 2", input=([[6, 8]],), result=[[6], [8]])
]
