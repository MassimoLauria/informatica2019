...
casi_di_test = [
    Testcase(name="monotonica",  input=('abcdefg',), result='gfedcba'),

    Testcase(name="palindroma",  input=('epoimartinalavavalanitramiope',), result='epoimartinalavavalanitramiope')
]
