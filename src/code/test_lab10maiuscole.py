...
esercizio_file = 'lab10maiuscole'
esercizio_funzione = 'copia_minuscola'

casi_di_test = [
    Testcase(name="stringa vuota", input=("", ), result=""),

    Testcase(name="senza maiuscole", input=("sono semplicemente parole minuscole senza punteggiatura",), result="sono semplicemente parole minuscole senza punteggiatura"),
