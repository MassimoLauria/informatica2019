...
esercizio_file = 'lab11frequenzaparole'
esercizio_funzione = 'frequenzaparole'

esempio_af = "penso troppo al mio futuro mi diceva delirando penso troppo al mio futuro penso troppo e vivo male"

casi_di_test = [
    Testcase(name="alberto fortis",
             input=(esempio_af, ),
             result={
                 'penso': 3,
                 'troppo': 3,
    ...
    Testcase(name="a capo", input=('parola \n parola', ), result={'parola':
                                                                  2}),
    Testcase(name="attaccate",
             input=('parolaparola parola', ),
             result={
                 'parola': 1,
                 'parolaparola': 1
             }),
    Testcase(name="staccate",
             input=('paro la parola', ),
             result={
                 'paro': 1,
                 'la': 1,
                 'parola': 1
             }),
    Testcase(name="singola", input=('aaaa', ), result={
        'aaaa': 1,
    }),
]
