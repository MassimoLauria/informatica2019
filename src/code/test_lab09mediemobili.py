...
esercizio_file = 'lab09mediemobili'
esercizio_funzione = 'medie_mobili'

casi_di_test = [
    Testcase(name="lista lunghezza 1", input=([3], 1), result=[3]),

    Testcase(name="lista lunghezza 6, k = 2", input=([3, 1, 8, -2, 4, -5], 2), result=[2, 4.5, 3, 1, -0.5]),

    Testcase(name="lista lunghezza 6, k = 4", input=([3, 1, 8, -2, 4, -5], 4), result=[2.5, 2.75, 1.25]),

    Testcase(name="lista lunghezza 6, k = 5", input=([3, 1, 8, -2, 4, -5], 5), result=[2.8, 1.2]),

    Testcase(name="lista lunghezza 6, k = 6", input=([3, 1, 8, -2, 4, -5], 6), result=[1.5]),
