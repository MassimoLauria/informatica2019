...
esercizio_file = 'lab10doppioni'
esercizio_funzione = 'elimina_duplicati'

casi_di_test = [
    Testcase(name="lista vuota", input=([], ), result=[]),

    Testcase(name="una sola parola", input=(["precipitevolissimevolmente"],), result=["precipitevolissimevolmente"]),

    Testcase(name="qualsiasi senza duplicati", input=(["buongiorno", "dall", "e", "in", "torno", "umbria", "vengo"], ),  result=["buongiorno", "dall", "e", "in", "torno", "umbria", "vengo"]),

    Testcase(name="con duplicati", input=(["buongiorno", "dall", "e", "e", "in", "torno", "umbria", "umbria", "vengo"], ),  result=["buongiorno", "dall", "e", "in", "torno", "umbria", "vengo"]),

    Testcase(name="con duplicati anche in testa", input=(["buongiorno", "buongiorno", "dall", "e", "e", "in", "torno", "umbria", "umbria", "vengo"], ),  result=["buongiorno", "dall", "e", "in", "torno", "umbria", "vengo"]),


    Testcase(name="parametro numerico", input=(4,),     error=TypeError,
             explanation="il parametro è un numero, non una lista"),

    Testcase(name="parametro stringa", input=("testoqualsiasi",),     error=TypeError,
             explanation="il parametro è una stringa, non una lista")
]
