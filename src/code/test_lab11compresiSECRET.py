...
esercizio_file = 'lab11compresi'
esercizio_funzione = 'compresi'

casi_di_test = [
    Testcase(name="intervallo_alto",
             input=([5, 2, 3, 2, 4, 4, 5, 6, 7], 10, 20),
             result=0),
    Testcase(name="intervallo_basso",
             input=([5, 2, 3, 2, 4, 4, 5, 6, 7], -20, -10),
             result=0),
    Testcase(name="intervallo_unitario_pos",
             input=([1, -9, 7, 3, -6, 3, 9, 8, -5], 3, 3),
             result=2),
    Testcase(name="intervallo_unitario_neg",
             input=([-6, 10, -4, 9, 0, 6, -10, 0], 7, 7),
             result=0),
    Testcase(name="intervallo_ampio",
             input=([1, -9, 7, -3, 7, 9, -1, 4], -10, 10),
             result=8),
    Testcase(name="intervallo_stretto",
             input=([1, 8, -2, -7, -4, -4, -9, -6, -4, 0], 10, -10),
             result=0),
]
