...
esercizio_file = 'lab11distanzaminima'
esercizio_funzione = 'distanza_minima'

casi_di_test = [
    Testcase(name="esempio n=8",
             input=([-7, -5, -4, 3, -7, 7, 2, 1], ),
             result=[0, 4]),
    Testcase(name="esempio n=4", input=([6, 2, -2, -5], ), result=[2, 3]),
    Testcase(name="esempio n=2", input=([6, 2], ), result=[0, 1]),
    Testcase(name="esempio ordinato n=4",
             input=([1, 3, 4, 8], ),
             result=[1, 2]),
    Testcase(name="esempio n=4 uguali", input=([4, 3, 4, 8], ), result=[0, 2]),
    Testcase(name="esempio n=4 estremi",
             input=([0, 3, 13, -6, 1], ),
             result=[0, 4]),
    Testcase(name="esempio n=7 incrementale",
             input=([128, 64, 16, 8, 4, 2, 1], ),
             result=[5, 6]),
]
