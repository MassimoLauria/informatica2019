...
esercizio_file = 'lab09creamatrice'
esercizio_funzione = 'crea_mat'

casi_di_test = [
    Testcase(name="nessuna riga",  input=(0, 3), error=ValueError,
             explanation="la matrice deve avere almeno una riga"),

    Testcase(name="nessuna colonna",  input=(2, 0), error=ValueError,
             explanation="la matrice deve avere almeno una colonna"),

    Testcase(name="numrighe non numerico",  input=("a", 5), error=TypeError,
             explanation="il primo parametro deve essere un numero"),

    Testcase(name="numcolonne non numerico",  input=(4, [2, 5]), error=TypeError,
             explanation="il secondo parametro deve essere un numero"),

    Testcase(name="matrice 4 x 1", input=(4, 1), result=[[0], [0], [0], [0]]),

    Testcase(name="matrice 4 x 2", input=(4, 2), result=[[0, 0], [0, 0], [0, 0], [0, 0]]),

    Testcase(name="matrice 3 x 2 val 5", input=(3, 2, 5), result=[[5, 5], [5, 5], [5, 5]]),

    Testcase(name="matrice 1 x 2 val xx", input=(1, 2, "xx"), result=[["xx", "xx"]]),

    Testcase(name="matrice 2 x 2 val xx", input=(2, 2, "xx"), result=[["xx", "xx"], ["xx", "xx"]])
]
