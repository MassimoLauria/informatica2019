...
esercizio_file = 'labEserc10_1'
esercizio_funzione = 'sostituisci_con_spazi'

casi_di_test = [
    Testcase(name="stringa vuota", input=("", ), result=""),

    Testcase(name="senza punteggiatura", input=("sono semplicemente parole senza punteggiatura",), result="sono semplicemente parole senza punteggiatura"),

    Testcase(name="qualsiasi", input=("Buongiorno, vengo dall'Umbria.", ),  result="Buongiorno  vengo dall Umbria "),

    Testcase(name="senza punteggiatura finale",  input=("In questo esempio (semplice) non c'è nulla in coda",), result="In questo esempio  semplice  non c è nulla in coda"),

    Testcase(name="parametro numerico", input=(4,),     error=TypeError,
             explanation="il parametro è un numero, non una stringa"),

    Testcase(name="parametro lista", input=(["w", 4],),     error=TypeError,
             explanation="il parametro è una lista, non una stringa")
]
