...
casi_di_test = [
    Testcase(name="unico", input=("Pippo, Pluto e Topolino incontrano Minnie. E lei li ignora, come se non li avesse visti!",), result=["avesse", "come", "e", "ignora", "incontrano", "lei", "li", "minnie", "non", "pippo", "pluto", "se", "topolino", "visti"])
