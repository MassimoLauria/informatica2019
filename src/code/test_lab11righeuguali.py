...
M = [[6, 2, -5, -7, 4], [-6, 10, -4, 10, -2], [-4, 6, 1, -8, 1],
     [-4, 8, 7, 2, -7], [-6, 10, -4, 10, -2], [-4, 6, 1, -8, 1],
     [-3, 8, -5, -9, 7], [-4, 6, 1, -8, 1], [-3, -3, -9, -5, -9]]

casi_di_test = [
    Testcase(name="esempio grande",
             input=(M, ),
             result=[[1, 4], [2, 5], [2, 7], [5, 7]]),
    Testcase(name="esempio piccolo", input=([[3, 4]], ), result=[]),
]
