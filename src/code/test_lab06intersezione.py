...
"""
ex_name      ='lab06intersezione'
ex_functions =['intersezione'] 
...
class TestLab06Intersezione(unittest.TestCase):
...
MOTIVO DEL FALLIMENTO:
    ...
    def test_liste_vuote(self):
        ...
        lista2=[]
        expected=[]
        result=intersezione(lista1,lista2)
    ...
    def test_lista_intersezione_vuotacoppia(self):
        lista1=[7, 1]
        lista2=[8, 12]
        expected=[]
        result=intersezione(lista1,lista2)
    ...
    def test_liste_permutate(self):
        ...
        result=intersezione(lista1,lista2).sort()
        msg=self.errormsg(lista1,lista2,expected,result)
        self.assertEqual(expected,result,msg=msg)
...
MOTIVO DEL FALLIMENTO:
    La funzione intersezione su input {0} e {1} dovrebbe sollevare
