...
"""
ex_name      ='lab08maxriga'
ex_functions =['pos_riga_massima_mat'] 
...
MOTIVO DEL FALLIMENTO:
    ...
    def test_mat_vuota(self):
        m=[]
        expected=-1
        result=pos_riga_massima_mat(m)
    ...
    def test_somma_massima_prima_riga(self):
        m=[[13, 1], [8, -2], [4, -5]]
        expected=0
        result=pos_riga_massima_mat(m)
        msg=self.errormsg(m,expected,result)
    ...
    def test_somma_massima_ultima_riga(self):
        m=[[13, 1], [8, -2], [4, 25]]
        expected=2
        result=pos_riga_massima_mat(m)
        msg=self.errormsg(m,expected,result)
    ...
    def test_somma_massima_riga_intermedia(self):
        m=[[13, 1], [8, -2], [25,6], [4, 25]]
        expected=2
        result=pos_riga_massima_mat(m)
        msg=self.errormsg(m,expected,result)
        self.assertEqual(expected,result,msg=msg)
...
MOTIVO DEL FALLIMENTO:
    La funzione pos_riga_massima_mat su input {0} dovrebbe sollevare
