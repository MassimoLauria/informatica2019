...
esercizio_file = 'lab09posmaxmm'
esercizio_funzione = 'pos_max_media_mobile'

casi_di_test = [
    Testcase(name="lista lunghezza 1", input=([3], 1), result=0),

    Testcase(name="lista lunghezza 6, k = 2", input=([3, 1, 8, -2, 4, -5], 2), result=1),

    Testcase(name="lista lunghezza 6, k = 2, max in testa", input=([30, 1, 8, -2, 4, -5], 2), result=0),

    Testcase(name="lista lunghezza 6, k = 2, max in coda", input=([3, 1, 8, -2, 4, 50], 2), result=4),

    Testcase(name="lista lunghezza 6, k = 4", input=([3, 1, 8, -2, 4, -5], 4), result=1),

    Testcase(name="lista lunghezza 6, k = 4, medie negative", input=([-12, -1, -1, -2, -4, -5], 4), result=1),

    Testcase(name="lista lunghezza 6, k = 4, max in testa", input=([30, 1, 8, -2, 4, -5], 4), result=0),

    Testcase(name="lista lunghezza 6, k = 4, max in coda", input=([3, 1, 8, -2, 4, 480], 4), result=2),

    Testcase(name="lista lunghezza 6, k = 5", input=([3, 1, 8, -2, 4, -5], 5), result=0),

    Testcase(name="lista lunghezza 6, k = 6", input=([3, 1, 8, -2, 4, -5], 6), result=0),

    Testcase(name="parametro non lista",  input=("pippo", 0), error=TypeError,
             explanation="una stringa non è una lista di numeri"),

    Testcase(name="primo parametro intero", input=(56, 1),     error=TypeError,
             explanation="un numero non è una lista"),

    Testcase(name="secondo parametro non intero", input=([56, 5], 1.5),     error=TypeError,
             explanation="il secondo parametro deve essere un intero"),

    Testcase(name="secondo parametro negativo", input=([56, 12], 0),     error=ValueError,
             explanation="il secondo parametro deve essere positivo"),

    Testcase(name="secondo parametro elevato", input=([56, 12, 23], 4),     error=ValueError,
             explanation="il secondo parametro non può essere maggiore della lunghezza della lista"),

    Testcase(name="lista non numerica",
             input=([[3, 5, "pippo", 8, 6]], 3),
             error=TypeError,
             explanation="il primo parametro deve essere una lista di numeri"),

    Testcase(name="parametro matrice",
             input=([[3, 5, 6], [3, 8, 6]], 3),
             error=TypeError,
             explanation="il primo parametro deve essere una lista di numeri, non una lista di liste")
]
