...
esercizio_file = 'labEserc10_4'
esercizio_funzione = 'parole_ordinate'
...
casi_di_test = [
    ...
    Testcase(name="qualsiasi", input=(["buongiorno", "vengo", "dall", "umbria", "e", "in", "umbria", "torno"], ),  result=["buongiorno", "dall", "e", "in", "torno", "umbria", "umbria", "vengo"]),
